...
def build(bld):
	sources = ["src/cpu.c", "src/fastfilters.c", "src/memory.c", "src/fir_kernel.c", "src/linalg.c", "src/fir_convolve_nosimd.c", "src/convolve.c", "src/fir_filters.c", "src/array.c", "src/iir_kernel.c"]
